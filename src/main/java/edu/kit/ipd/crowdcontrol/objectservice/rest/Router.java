...
public class Router implements SparkApplication {
     ...
     */
    public Router(TemplateResource templateResource, NotificationResource notificationResource, PlatformResource platformResource, WorkerResource workerResource) {
    ...
    public void init() {
        ...
        get("/workers/:platform/identify", workerResource::identify);
    }
