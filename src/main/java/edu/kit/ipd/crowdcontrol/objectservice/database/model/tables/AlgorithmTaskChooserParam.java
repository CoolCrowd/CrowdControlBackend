...
public class AlgorithmTaskChooserParam extends org.jooq.impl.TableImpl<edu.kit.ipd.crowdcontrol.objectservice.database.model.tables.records.AlgorithmTaskChooserParamRecord> {
	...
	private static final long serialVersionUID = -912785231;
	 ...
	 */
	public final org.jooq.TableField<edu.kit.ipd.crowdcontrol.objectservice.database.model.tables.records.AlgorithmTaskChooserParamRecord, java.lang.String> ALGORITHM = createField("algorithm", org.jooq.impl.SQLDataType.VARCHAR.length(45).nullable(false), this, "");
